...
function abrirURL(){
    ...
    window.location = "https://appmeloexpress.com/pedido/crearcas";
};
</script>
...
<section class="section">
    <div class="section-header">
        <h3 class="page__heading">Crear Envio Casillero</h3>
    </div>
...
-->
        ...
        <div class="row">
            <div class="col-10 ">
            <form action="/comerfiltroca" method="GET" id="myForm" >
                    @method('GET') 
            <input type="text"  hidden >
                <label for="" class="col-10 col-form-label">Comercio / Tienda *</label>
      
               <input type="text" id="busc" name="busc" class="form-control" tabindex="2" placeholder="Ingresar al menos 3 caracteres" required>
            ...
            <div class="col-2 pt-4" style="display: flex; align-items: center;">
                 <button type="submit" name="perso" class="btn btn-primary" tabindex="19">Buscar</button>
            </div>
        ...
        <div class="row">
          ...
          <div class="input-group-prepend">
           ...
           <input type="text" id="precio" name="precio" class="form-control" placeholder="Precio"  value="0" tabindex="7">
              <div class="valid-feedback"><i class="fas fa-check-circle"></i>&nbsp;Correcto</div>  
            </div>
            </div>
            ...
            <div class="input-group">
              <div class="input-group-prepend">
                ...
                <input type="text" id="envio" name="envio" class="form-control" placeholder="Envio" aria-label="Username" value="0" tabindex="8">
                <div class="valid-feedback"><i class="fas fa-check-circle"></i>&nbsp;Correcto</div>  
          </div> 
            </div>
...
-->
  ...
  -->
  <a href="/pedido/crearcas" class="btn btn-primary">Limpiar</a>
        &nbsp; &nbsp;<!--
