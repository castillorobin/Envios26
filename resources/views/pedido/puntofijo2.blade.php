...
<section class="section">
    <div class="section-header">
        <h3 class="page__heading">Crear Envio Punto Fijo</h3>
    </div>
...
-->
        ...
        <div class="row">
            ...
            <input type="text" hidden >
                ...
                <select id="comer" name="comer" class="form-control mi-selector1" tabindex="1"  autofocus required multiple="multiple">
            ...
            <div class="col-2 pt-4" style="display: flex; align-items: center;">
                <a href="/pedido/comerpfijo">+ Crear</a>
            </div>
        </div>
