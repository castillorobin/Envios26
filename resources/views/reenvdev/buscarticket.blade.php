        ...
        <div class="col-md-6">
            <div class="card">
                <div class="card-header text-center">
                    <h5 class="card-title mb-0">Busqueda por ticket</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('ordenes.ticket_detallesdevo') }}" method="POST" id="form-busqueda">
                        @csrf
                        <div class="mb-3">
                            <label class="form-label">Escanear o Ingresar Ticket</label>
                            <div class="input-group">
                                <input type="text" name="ticket" id="guia_input" 
