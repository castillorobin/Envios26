    ...
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
    <form action="{{ route('reportes.crearreporteunidades') }}" method="POST" id="form-busqueda">
        @csrf
       

        <div class="mb-3">
        <div class=" w-100">
                    <select name="unidad" class="form-select select2" required>
...
<script>
    $(document).ready(function() {
        $('.select2').select2({
            placeholder: "Seleccione el unidad...",
            allowClear: true,
