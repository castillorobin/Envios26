                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="mb-0 fw-semibold">Listado de Unidades</h4>
                                    ...
                                    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
                                        <div>
                                            <form class="d-flex flex-wrap align-items-center gap-2">
                                                <label for="inputPassword2" class="visually-hidden">Buscar Unidad</label>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                              ...
                                              <td class="text-center">
                                                ...
                                                <form action="{{ route('unidades.destroy', $unidad->id) }}" method="POST" class="d-inline form-eliminar">
                                                    @csrf
                                                    @method('DELETE')
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title" id="modalPuntoLabel">Nueva Unidad</h5>
            ...
            <form action="{{ route('unidades.store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="text" name="nombre" class="form-control" placeholder="Ingrese el número de unidad" >
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Placas</label>
                        <input type="text" name="placas" class="form-control" placeholder="Ingrese las placas" >
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="tipo" id="tipo_punto" class="form-select" >
        ...
        <div class="modal-content">
            ...
            <form id="formEditarUnidad" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        <label class="form-label">Placas</label>
                        <input type="text" name="placas" id="edit_placas" class="form-control" >
                    </div>
                    <div class="mb-3">
                        <label class="form-label">Marca</label>
...
$(document).ready(function() {
   ...
   $(document).on('click', '.btn-editar', function() {
    // Obtenemos los datos desde el botón
    const id = $(this).data('id');
    const nombre = $(this).data('nombre');
    const placas = $(this).data('placas');
    ...
    $('#formEditarUnidad').attr('action', '/unidades/' + id);

    // Llenamos los inputs del modal
    $('#edit_nombre').val(nombre);
    $('#edit_placas').val(placas);
    ...
    $(document).on('click', '.btn-borrar', function(e) {
        ...
        Swal.fire({
            title: '¿Estás seguro?',
            text: "Esta acción eliminará la unidad de forma permanente.",
            icon: 'warning',
