                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="page-title-box">
                                <h4 class="mb-0 fw-semibold">Listado de Cajas</h4>
                                    ...
                                    <div class="d-flex flex-wrap justify-content-between align-items-center gap-2">
                                        <div>
                                            <form class="d-flex flex-wrap align-items-center gap-2">
                                                <label for="inputPassword2" class="visually-hidden">Buscar Caja</label>
                                                <div class="search-bar me-3">
                                                    <span><i class="bx bx-search-alt"></i></span>
                                                    <input type="search" class="form-control" id="search" placeholder="Buscar Caja ...">
                                                </div>
                                        ...
                                        <div>
                                           <div class="d-flex flex-wrap gap-2 justify-content-md-end align-items-center">
                                            ...
                                            <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#kt_modal_stacked_1">
                                            ...
                                            <tr>
                                              ...
                                              <td class="text-center">
                                                <button type="button" class="btn btn-sm btn-soft-secondary me-1 btn-editar" 
                                                        data-id="{{ $cajon->id }}" 
                                                        data-nombre="{{ $cajon->concepto }}" 
                                                        data-tipo="{{ $cajon->tipo }}"
                                                        data-bs-toggle="modal" data-bs-target="#modalEditarCajon">
                                                    <i class="bx bx-edit fs-18"></i>
                                                </button>

                                                <form action="{{ route('cajones.destroy', $cajon->id) }}" method="POST" class="d-inline form-eliminar">
                                                    @csrf
                                                    @method('DELETE')
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-light">
                <h5 class="modal-title" id="modalPuntoLabel">Nueva Caja</h5>
            ...
            <form action="{{ route('cajones.store') }}" method="POST">
                ...
                <div class="modal-body">
                    <div class="mb-3">
                        ...
                        <input type="number" name="numero" class="form-control" placeholder="Ingrese el número de caja" required>
                    </div>
